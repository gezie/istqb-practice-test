...
import { ClipboardCheck, BookOpenCheck, PlayCircle } from "lucide-react"
import { cn } from "@/lib/utils"
import { CHAPTERS } from "@/lib/chapters"

export function TestConfiguration(){const router=useRouter();const[mode,setMode]=useState("quick");const[selected,setSelected]=useState<number[]>([1]);
 ...
 <div className="mt-5 grid gap-3 sm:grid-cols-2">{[
  ["quick","Rychlý test (40 otázek)","Otázky podle oficiálních vah zkoušky CTFL v4.0.",ClipboardCheck],
